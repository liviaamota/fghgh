...
5°criar um script chamado: "start": "node --import=tsx --watch ./src/server.ts"
6°npm i express(biblioteca para criar o servidor)
7°npm i -D @types/experss
